...
class offline_tsds_Selector:
    def __init__(self,
                 candidate_path = "/home/lianghao/yry/DataFlex-yry/data/alpaca_zh_demo.json",
                 query_path: str = "/home/lianghao/yry/DataFlex-yry/data/alpaca_en_demo.json",
                 embed_model: str = "/home/lianghao/yry/LLaMA-Factory/Qwen2.5-0.5B-Instruct",
                 batch_size: int = 32,
    ...
    def _embed_texts(self, texts):
        if VLLM_AVAILABLE and self.embed_model.startswith("vllm:"):
            ...
            sampling = SamplingParams(max_tokens=16, temperature=0)
            outputs = llm.encode(texts, sampling)  
    ...
    def selector(self):
        ...
        MAX_K = min(self.max_K, N // 10)
        KDE_K = min(self.kde_K, N // 10)
...
if __name__ == "__main__":
    tsds = offline_tsds_Selector(
        candidate_path="/home/lianghao/yry/DataFlex-yry/data/alpaca_en_demo.json",
        query_path="/home/lianghao/yry/DataFlex-yry/data/alpaca_zh_demo.json",
        embed_model="/home/lianghao/yry/LLaMA-Factory/Qwen2.5-0.5B-Instruct",
        batch_size=32,
